...
import {
  LayoutDashboard, UserPlus, FileText, Calendar, LayoutGrid,
  Bell, LogOut, Menu, X, Sun, Moon, Activity, Settings,
...
const THEME = {
  ...
  logoBox:         { dark: 'bg-slate-800',                    medical: 'bg-blue-700',                 light: 'bg-blue-600' },
          ...
          {!isCollapsed && (
            <div className={STYLES.logoRow}>
              ...
              <div>
                ...
                <span className={STYLES.portalLabel}>Panel Médico</span>
              </div>
            </div>
          )}
          {isCollapsed && (
          ...
          <div className={STYLES.headerLeft}>
            ...
            <div className={STYLES.mobileLogo}>
              ...
              <div>
                ...
                <span className={STYLES.mobilePortalLabel}>Panel Médico</span>
              </div>
            </div>
          </div>
